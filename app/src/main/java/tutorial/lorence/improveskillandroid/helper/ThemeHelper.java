...
import tutorial.lorence.improveskillandroid.custom.IIcon;
import tutorial.lorence.improveskillandroid.custom.IconicsDrawable;
import tutorial.lorence.improveskillandroid.custom.Theme;
...
public class ThemeHelper {
    ...
    public ArrayAdapter<String> getSpinnerAdapter(ArrayList<String> items) {
        switch (baseTheme){
            case AMOLED: case DARK: return new ArrayAdapter<String>(context, R.layout.spinner_item_light, items);
            case LIGHT: default: return new ArrayAdapter<String>(context, R.layout.spinner_item_dark, items);
        }
    }
